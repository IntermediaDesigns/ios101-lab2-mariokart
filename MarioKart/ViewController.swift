    ...
    SettingsViewControllerDelegate
{
    ...
    @IBAction func didLongPressBackground(
    ...
    func applyNumKartsSetting(_ settings: [String: Any]) {
        ...
        kartView0.isHidden = numKarts < 3
        kartView1.isHidden = numKarts < 2
        kartView2.isHidden = numKarts < 1
    }
    ...
    func applyKartSizeSetting(_ settings: [String: Any]) {
        ...
        let kartSize = 1.0 + 0.1 * Double(kartSizeMultiplier)
        let transform = CGAffineTransformIdentity.scaledBy(
            x: kartSize, y: kartSize)
